...
! function() {
    ...
    ! function() {
        ...
        return a = function() {}, a.extend = function(a) {
            function d() {
    ...
    f.prototype = {
        ...
        _validateSchema: function(a, b, e) {
            ...
            if ("number" == typeof b)(a.multipleOf || a.divisibleBy) && (g = b / (a.multipleOf || a.divisibleBy), g !== Math.floor(g) && k.push({
                ...
                var p = {};
                if (a.properties)
                    for (h in a.properties) a.properties.hasOwnProperty(h) && (p[h] = !0, k = k.concat(this._validateSchema(a.properties[h], b[h], e + "." + h)));
        ...
        preBuild: function() {
            ...
            if (this.input_type = "select", this.enum_options = [], this.enum_values = [], this.enum_display = [], this.schema["enum"]) {
                ...
                if (this.enumSource = [], this.enum_display = [], this.enum_options = [], this.enum_values = [], Array.isArray(this.schema.enumSource))
                    for (h = 0; h < this.schema.enumSource.length; h++) "string" == typeof this.schema.enumSource[h] ? this.enumSource[h] = {
                        source: this.schema.enumSource[h]
                    } : Array.isArray(this.schema.enumSource[h]) ? this.enumSource[h] = this.schema.enumSource[h] : this.enumSource[h] = c({}, this.schema.enumSource[h]);
        ...
        onInputChange: function() {
            var a = this.input.value,
                b = a; - 1 === this.enum_options.indexOf(a) && (b = this.enum_options[0]), this.value = this.enum_values[this.enum_options.indexOf(a)], this.onChange(!0)
        },
